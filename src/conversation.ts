...
{
  "activeTopic": "הנושא של ההודעות האחרונות בלבד (משפט אחד) — לא של הסיכום הקודם",
...
כללים:
- activeTopic חייב לשקף את הנושא של ההודעות החדשות — אם המשתמש עבר נושא, עדכן! אל תעתיק activeTopic ישן.
- החלטות ישנות נשארות ב-recentDecisions (לא מתאבדות) — אבל activeTopic תמיד של הנושא הנוכחי.
- שמור על שמות מדויקים של אנשים
- שמור על תאריכים וזמנים ספציפיים
- מקסימום 5 פריטים בכל רשימה
- אם יש סיכום קודם, מזג פרטים רלוונטיים — אבל activeTopic תמיד מתעדכן לפי ההודעות האחרונות
- כתוב בעברית`;
