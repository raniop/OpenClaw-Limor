...
const CONTACT_PATTERNS = /(איש קשר|מספר של|טלפון של|contact|אנשי קשר|תוסיפי את|תוסיף את|vcard|vcf|BEGIN:VCARD|תאשרי (את|אותה|אותו)|אשרי (את|אותה|אותו)|לאשר את|תחסמי את|חסמי את|approve .*contact|block .*contact)/i;
