...
import {
  ...
  crmTools, instructionTools, fileTools, contactTools, smartHomeTools, capabilityTools, modelTools, codingTools, gettTools, whatsappExtraTools, smsTools, webSearchTools, agentTools, nimrodTools, healthTools, officePcTools, planTools, selfAwarenessTools,
} from "./tools";
...
const SEND_MESSAGE_TIMEOUT_MS = 600_000; // 10 minutes — Yuri coding tasks can take 5-6 min
  ...
  let tools = !toolsEnabled
    ...
    : sender?.isOwner
      ? [
          ...
          ...agentTools, ...healthTools, ...officePcTools, ...capabilityTools, ...planTools, ...selfAwarenessTools,
        ]
