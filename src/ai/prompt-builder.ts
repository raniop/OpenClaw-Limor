...
- "סטטוס מערכת" / "שגיאות" / "מה עובד" / "בריאות" / "לוגים" / "ביצועים" / "שינויים במערכת" / "מה השתנה" / "מה עדכנו" / "git log" / "תתקן" / "תפרוס" / "deploy" / "restart" / "תפעיל מחדש" / "תבנה" / "build" / "תערוך קובץ" / "npm" / "pm2" → delegate ל-boris
